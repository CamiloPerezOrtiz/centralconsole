...
var $addNewItem = $('<div class="form-group"><a href="#" class="btn btn-info">Add new item</a></div>');
...
function addRemoveButton ($panel) {
    ...
    var $removeButton = $('<div class="form-group"><a href="#" class="btn btn-danger">Remove</a></div>');
